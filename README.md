...
In a quiet polder below sea level, an old keeper named Bram tended a single field of tulips that glowed brighter than any other.
...
Each spring since, the polder blooms in a single radiant stripe of tulips, and the people call it the Keeper's Promise.
